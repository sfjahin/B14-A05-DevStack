    ...
    return (
        <div className='flex flex-col gap-2 p-5 border-1 border-gray-300 rounded-2xl h-full'>
            ...
            <button
                ...
                disabled={isSelected}
                className={`rounded-md w-full p-2 text-[18px] mt-4 flex justify-center items-center gap-1 ${isSelected ? 'bg-pink-200 text-pink-700 cursor-not-allowed' : 'bg-black text-white'
                    }`}
            >
